 ...
 *  @param[out] gyro        Gyro data in hardware units.//陀螺仪原始数据
 *  @param[out] accel       Accel data in hardware units.//加速度原始数据
 *  @param[out] quat        3-axis quaternion data in hardware units.//四元素数据 
 *  @param[out] timestamp   Timestamp in milliseconds.//时间戳以毫秒为单位
 *  @param[out] sensors     Mask of sensors read from FIFO.//传感器读取FIFO的面具
 *  @param[out] more        Number of remaining packets.//数量的剩余的包
 *  @return     0 if successful.
 */
